...
> $$
> since by the Archimedean Property ([link](1767464355-HTFW.md)), for any $a\in\mathbb{R}$ there exists $n\in\mathbb{N}$ with $a<n$, hence $a\notin [n,\infty)$. Therefore, in the classical nested intervals result we require both closedness and boundedness.
...
> [!pf] Proof
> Since $a_n\le b_n\le b_1$ for all $n$, the set $A=\{a_n\}$ is nonempty and bounded above; by the Completeness Property of $\mathbb{R}$ ([link](1767467862-FFER.md)), $\xi:=\sup A$ exists.
> 
...
*Extracted to: [[L06 - Intervals and Sequences - Intervals]]*

## Sequences

*Extracted to: [[L06 - Intervals and Sequences - Sequences]]*
