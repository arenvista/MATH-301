...
References/Notes: Quiz 1 [1.3, 2.1, 2.2]
# Extractions -------------
# Intervals (Section 2.5)
...
*Extracted to: [[L05 - Intervals (Section 2.5) - Basic Notation]]*

## Classification by Boundedness

*Extracted to: [[L05 - Intervals (Section 2.5) - Classification by Boundedness]]*
