...
> - For any $a,b\in\mathbb{R}$, exactly one of $a>b$, $a=b$, or $a<b$ holds (trichotomy).# Extractions -------------
---
id: L02
aliases: []
tags: []
...
*Extracted to: [[L02 - Finite and Infinite Sets]]*

# Section 2.1: Real Numbers

*Extracted to: [[L02 - Section 2.1 Real Numbers]]*

# Ordering Properties of ℝ

*Extracted to: [[L02 - Ordering Properties of ℝ]]*
