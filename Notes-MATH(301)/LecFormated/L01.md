...
> 
> For the second bullet, argue by contrapositive: if $S$ were finite, then by the first bullet every subset $T\subseteq S$ would be finite, contradicting that $T$ is infinite. Hence $S$ is infinite.# Extractions -------------
---
id: L01
aliases: []
tags: []
...
*Extracted to: [[L01 - Section 1.3 Finite and Infinite Sets]]*
