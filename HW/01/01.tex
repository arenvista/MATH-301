...
\textbf{Question:} Prove that a nonempty set $T_1$ is finiti iff there is a bijection from $T_1$ onto a finite set $T_2$.
...
\textbf{Question:} Give an examply of a countable collection of finite sets whose union is not finite. 
