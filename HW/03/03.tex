...
\[ \text{Let } |S| = n \in \mathbb{N} ~\text{Consider ordering of } S := \{ s_1 \leq s_2 \leq ... \leq s_n  \} \]
\[ \text{Define } T := \{ -s : s \in S \} ~\text{Observe } u:= \inf S \implies u \leq s_1 \]
\[ \text{Consider ordering of } T := \{ -s_1 \geq -s_2 \geq ... \geq -s_n  \} \]
\[ \text{$S$ is bounded below} \implies -S \text{ is bounded above} \implies  \exists ~\sup -S \]
\[ \text{Observe } u:= \inf S \implies -u \geq -s_1 \]
\[ \text{Thus } -u \geq -s_1 \geq -s_2 \geq ... \geq -s_n \implies \forall ~x \in -S, -u \geq x \implies -u \text{ is an upperbound of } S\]
