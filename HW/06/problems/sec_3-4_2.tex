...
\text{Observe: } 0 < c < 1 \implies \lim_{n \to \infty} c^n = 0 \implies \forall~ n \in \mathbb{N}, c_n \in (0,1]  ~\land~ c^n < c^{n+1}\\
\begin{aligned}
c^n \cdot c^{\frac{1}{n^2}} & < c^{n+1} \cdot c^{\frac{1}{n^2}}  \\
c^{\frac{1}{n}}  & <  c^{\frac{1}{n} + \frac{1}{n^2}} \\
\end{aligned} \\
\therefore c^{\frac{1}{n}} < c^{\frac{1}{n+1}} \\
\therefore ~c^{n+1} < c^n < c^\frac{1}{n} < c^{\frac{1}{n+1}} \implies \text{ $c^n$ is monotonic and increasing.}\\
\text{Let } c_{2n} \text{ be a subsequence of $c_n$ containing even naturals} \\
