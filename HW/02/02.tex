...
\[
	\begin{cases}
		\text{Cases 1: } (a=b) & \implies a^n = b^n \text{ \lightning}    \\
		\text{Cases 2: } (a>b) & \implies a^n > b^n \text{ \lightning}    \\
		\text{Cases 3: } (a<b) & \text{ Must hold by Trichotomy Property} \\
	\end{cases}
\]
\begin{center}
...
\[
    \begin{cases}
        \text{Case 1: } b>0 & |a/b|= |a| \cdot |1/b| \implies 1/b >0           \\
        \text{Case 2: } b<0 & |a/b|= a \cdot -(1/b) = a \cdot 1/(-b) \implies 1/b<0 
    \end{cases} \\
\]
\[
	\therefore |a/b| = |a|/|b|
